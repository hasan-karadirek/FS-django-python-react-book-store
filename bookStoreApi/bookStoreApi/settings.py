...
AWS_ACCESS_KEY_ID = os.getenv("AWS_ACCESS_KEY_ID",'AKIA4XRTQTWY45AEWKFC')
AWS_SECRET_ACCESS_KEY = os.getenv("AWS_SECRET_ACCESS_KEY","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")
AWS_STORAGE_BUCKET_NAME = os.getenv("AWS_STORAGE_BUCKET_NAME","bookstorestatic")
