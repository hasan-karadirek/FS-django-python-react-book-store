...
CORS_ALLOWED_ORIGINS = ["http://s3bookstore.eu-north-1.elasticbeanstalk.com","http://localhost:8000"
]
...
AWS_S3_REGION_NAME = os.getenv('AWS_S3_REGION_NAME', default='us-east-1')  # Change to your region
