...
class BookOnSale(models.Model):
    ...
    condition = models.CharField(
        max_length=50, choices=conditionChoices, verbose_name="Condition of the Book"
    )
...
class BookOnSaleImage(models.Model):
    book = models.ForeignKey(
        BookOnSale, related_name="on_sale_images", on_delete=models.CASCADE
    )
...
class OrderDetail(models.Model):
    ...
    book_on_sale = models.ForeignKey(
        BookOnSale, related_name="book_on_sale", on_delete=models.CASCADE
    )
