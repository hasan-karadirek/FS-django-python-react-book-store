...
const Testimonials: React.FC = () => {
    ...
    <div className="container testimonials">
        ...
        <br />
        <h4 id="testimonials-title">We are excited about our customer reviews</h4>
        <br />
        <div id="carousel-testimonials" className="carousel carousel-dark slide">
            <div className="carousel-indicators">
                <button type="button" data-bs-target="#carousel-testimonials" data-bs-slide-to="0" className="active" aria-current="true" aria-label="Slide 1"></button>
                    ...
                    <div className="carousel-caption  d-md-block">
                        <div className="testimonial-blockquote">
                            <blockquote style={{ position: "relative" }}>
                                <p className="testimonial-message">cok iyi cok iyi cok iyi cok iyi cok iyi cok iyi cok iyi cok iyi cok iyi cok iyi asfasf aa sf asdf as fdq  wg a s fa f a s f as</p>
                            </blockquote>
                        </div>
                    </div>
                </div>
