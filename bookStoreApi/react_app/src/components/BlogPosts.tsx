...
const posts: Post[] = [
  {
    id: 1,
    title:
      "Post One Post One Post One Post One Post One Post One Post One Post One Post One ",
    imageUrl: "https://via.placeholder.com/150",
    desc: "desc 1 desc 1 desc 1 desc 1 desc 1 desc 1 desc 1 desc 1desc 1 desc 1 desc 1 desc 1desc 1 desc 1 desc 1 desc 1desc 1 desc 1 desc 1 desc 1desc 1 desc 1 desc 1 desc 1",
  },
  {
    id: 2,
    title: "Post Two",
    imageUrl: "https://via.placeholder.com/180",
    desc: "desc 2 desc 2 desc 2 desc 2",
  },
  {
    id: 3,
    title: "Post Three",
    imageUrl: "https://via.placeholder.com/240",
    desc: "desc 3 desc 3 desc 3 desc 3",
  },
  {
    id: 4,
    title: "Post One",
          ...
          <div className="accordion" id="accordion-posts">
            {posts.map((post) => (
              ...
              >
                ...
                >
                  <div className="accordion-body">{post.desc}</div>
                </div>
              </div>
            ))}
          </div>
