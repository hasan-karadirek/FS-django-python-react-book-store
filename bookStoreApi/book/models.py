...
class Book(models.Model):
    ...
    language=models.ForeignKey(Language,related_name="books",on_delete=models.SET_NULL, null=True)
    ...
    publishing_house = models.ForeignKey(PublishingHouse,related_name="books",on_delete=models.SET_NULL, null=True)
    year=models.IntegerField(validators=[MinValueValidator(1700), MaxValueValidator(datetime.date.today().year)])
