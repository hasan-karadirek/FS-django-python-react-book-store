...
from .models import Book, Author, PublishingHouse, BookImage,Language,Category,Tag,BookTagAssociation
...
class BookSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        book = Book.objects.create(
            author=author, publishing_house=publishing_house, language=language, category=category, **validated_data
        )
    ...
    def update(self, instance, validated_data):
        ...
        instance.condition_description = validated_data.get("condition_description", instance.condition_description)
