...
from .views import AddPostAPIView,UpdatePostAPIView,DeletePostAPIView,CreateFormAPIView, GetPostsAPIView,GetPostAPIView, DeleteFormAPIView, GetFormAPIView,GetFormsAPIView
